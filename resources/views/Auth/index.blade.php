            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <a href="#" class="auth-logo-light">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{asset('adminassets/images/logo-light.svg')}}" alt="" class="rounded-circle" height="34">
                                    </span>
                                </div>
                            </a>
                        ...
                        <div class="p-2">
                            <form method="POST" action="{{ route('Auth.login') }}" >
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{route('Auth.Password')}}" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                                </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>© <script>document.write(new Date().getFullYear())</script> Skote. Crafted with <i class="mdi mdi-heart text-danger"></i> by Admin</p>
                    </div>
                </div>
