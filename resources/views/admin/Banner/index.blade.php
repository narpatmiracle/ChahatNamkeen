            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">Admin / Banner list</li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="page-title-right">
                        <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><a
                                href="{{ route('Banner.Create') }}" style="color:aliceblue"><i
                        ...
                        <tbody>
                            @foreach ($data as $key => $Banner)
                                <tr>
                                    ...
                                    <td>{{ $Banner->Name }} </td>
                                    <td>
                                        <img src="{{ asset('/adminassets/Uploads/Banner') . '/' . $Banner->image }}"
                                            width="100px">
                                    </td>
                                    <td>
                                        @if ($Banner->status == 1)
                                        ...
                                        @else
                                            <button type="button" class="btn btn-danger changeStatus"
                                                data-id="{{ $Banner->id }}">Deactive</button>
                                        @endif
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm btn-rounded ShowModel"
                                            id="ShowModel" data-id="{{ $Banner->id }}" data-bs-toggle="modal"
                                    ...
                                    <td>
                                        <div class="action">
                                            ...
                                            <a href="{{ Route('Banner.delete', $Banner->id) }}"
                                                ...
                                                data-id="{{ $Banner->id }}"><button type="button"
    ...
    <script>
        $(function() {
            $('.changeStatus').on('click', function(e) {
                e.preventDefault();
                var id = $(this).data('id');
                var url = '{{ route('Banner.chnageStatus') }}';
                $.ajax({
                    type: 'post',
                    url: url,
                    data: {
