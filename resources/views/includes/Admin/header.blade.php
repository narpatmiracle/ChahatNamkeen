        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{route('admin.dashboard')}}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('adminassets/images/logo-light.svg')}}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('adminassets/images/logo-light.png')}}" alt="" height="19">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @if(!Auth::user()->image)
                            ...
                            <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Header Avatar" class="rounded-circle header-profile-user">

                            @else
                            <img src="{{ asset('/adminassets/Uploads/Profile').'/'.Auth::user()->image }}" alt="Header Avatar" class="rounded-circle header-profile-user">
                            @endif
